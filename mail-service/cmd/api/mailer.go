...
func (m *Mail) buildHTMLMessage(msg Message) (string, error) {
	baseTpl := "./templates/mail.gohtml"

	t, err := template.New("email-html").ParseFiles(baseTpl)
	if err != nil {
		return "", err
	}
...
func (m *Mail) buildPlainTextMessage(msg Message) (string, error) {
	baseTpl := "./templates/mail-plain.gohtml"

	t, err := template.New("email-plain").ParseFiles(baseTpl)
	if err != nil {
		return "", err
	}
